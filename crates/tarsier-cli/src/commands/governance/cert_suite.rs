...
use super::{
    is_valid_sha256_hex, CertSuiteAssumptions, CertSuiteCheckReport, CertSuiteEntry,
    CertSuiteEntryReport, CertSuiteManifest, CertSuiteReport,
...
mod tests {
    ...
    fn model_hash_consistency_disabled() {
        ...
        assert!(
            validate_manifest_model_hash_consistency(&manifest, Path::new("/tmp/m.json"))
                .is_empty()
        );
    }
